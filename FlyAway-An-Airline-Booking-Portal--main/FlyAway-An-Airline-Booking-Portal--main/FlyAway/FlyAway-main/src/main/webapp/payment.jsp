...
<body>
	<div class="container mt-4 d-flex justify-content-center main">
		<div class="card">
			<div class="d-flex justify-content-between px-3 pt-4">
				...
				<div class="amount">
					<div class="inner">
						<span class="rand">R</span> <span class="total"><%=totalTicketPrice%></span>
					</div>
				</div>
			</div>
			<form action="ticket.jsp" method="post">
				...
				<div class="d-flex justify-content-between px-3 pt-4">
					<div>
						<label for="date" class="exptxt">Expiry Date</label> <input
	...
	<footer class="bg-light text-center text-lg-start mt-auto">
		...
		<div class="text-center p-3">
			© 2023 Copyright:
			<h5 class="text-dark">FlyAway | Developed by Edwina Thaba</h5>
		</div>
		<!-- Copyright -->
	</footer>
